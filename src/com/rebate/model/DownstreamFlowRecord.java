 ...
 * 下游流向明细
 */
public class DownstreamFlowRecord {
    private Long id;
    private Long projectId;
    private Long agreementId;
    private Long batchId;
    private Long upstreamFlowRecordId;
    ...
    public Long getUpstreamFlowRecordId() { return upstreamFlowRecordId; }
    public void setUpstreamFlowRecordId(Long upstreamFlowRecordId) { this.upstreamFlowRecordId = upstreamFlowRecordId; }
    ...
    public Timestamp getInvalidTime() { return invalidTime; }
    public void setInvalidTime(Timestamp invalidTime) { this.invalidTime = invalidTime; }
