 ...
 * 下游协议
 */
public class DownstreamAgreement {
    private Long id;
    ...
    private List<RebateRule> rebateRules;
    private List<AssessDownstreamTarget> assessTargets;
    ...
    public void setUpstreamId(Long upstreamId) { this.upstreamId = upstreamId; }
    ...
    public List<RebateRule> getRebateRules() { return rebateRules; }
    public void setRebateRules(List<RebateRule> rebateRules) { this.rebateRules = rebateRules; }
    public List<AssessDownstreamTarget> getAssessTargets() { return assessTargets; }
    public void setAssessTargets(List<AssessDownstreamTarget> assessTargets) { this.assessTargets = assessTargets; }
}
